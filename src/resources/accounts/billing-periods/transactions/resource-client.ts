...
import * as requests from "new-day-ts/resources/accounts/billing-periods/transactions/request-types";
...
export class TransactionsClient extends CoreResourceClient {
  ...
  > {
    return this._client.makeRequest({
      method: "get",
      path: `/accounts/${request.accountId}/billing-periods/${request.billingPeriodId}/transactions`,
      query: [
